...
def main(cfg: omegaconf.DictConfig):
    ...
    if flag == 'dream3dvg': # 3dvg
        from pytorch_svgrender.pipelines.Dream3DVG_pipeline import Dream3DVGPipeline

        pipe = Dream3DVGPipeline(cfg)
        pipe.painterly_rendering()
        
    elif flag == "diffvg":  # img2svg
