...
from pytorch_svgrender.utils.sh_utils import eval_sh, SH2RGB
from pytorch_svgrender.utils.graphics_utils import fov2focal
import random

def gs_render(viewpoint_camera, pc : GaussianModel, bg_color : torch.Tensor, convert_SHs_python: bool = False, compute_cov3D_python: bool = False, scaling_modifier = 1.0, black_video = False,
    ...
    screenspace_points = torch.zeros_like(pc.get_xyz, dtype=pc.get_xyz.dtype, requires_grad=True, device="cuda") + 0 # (100000, 3)
    try:
    ...
    try:
        raster_settings = GaussianRasterizationSettings(
            ...
            viewmatrix=viewpoint_camera.world_view_transform, # here is w2c
    ...
    opacity = pc.get_opacity # (100000, 1)
    ...
    if colors_precomp is None:
        if convert_SHs_python:
            ...
            shs = pc.get_features # (100000, 1, 3)
    else:
    ...
    # rendered_image -> (3, 512, 512) radii -> (100000) depth_alpha -> (2, 512, 512)
